    ...
    public void setStatusBar(final String json) {
        mainHandler.post(() -> {
            try {
                ...
                if (opts.has("statusBar")) {
                    int statusColor = android.graphics.Color.parseColor(opts.getString("statusBar"));
                    activity.getWindow().setStatusBarColor(statusColor);
                }
                if (opts.has("navigationBar")) {
                    int navColor = android.graphics.Color.parseColor(opts.getString("navigationBar"));
                    activity.getWindow().setNavigationBarColor(navColor);
                }
                if (opts.has("webView") && webView != null) {
                    webView.setBackgroundColor(android.graphics.Color.parseColor(opts.getString("webView")));
                }
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
