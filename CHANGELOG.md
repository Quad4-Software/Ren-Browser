...
- Upgrade Wails from v3.0.0-beta.8 to v3.0.0-beta.9
- Bump frontend, Go, GitHub Actions, pnpm, Task, and Trivy dependencies to current releases

## [0.3.0] [released] - 2026-08-18
