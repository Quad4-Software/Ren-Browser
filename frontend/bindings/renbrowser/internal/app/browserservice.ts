 ...
 */
export function FetchNodeImage(rawURL: string, imageKey: string, profile: string, reload: boolean): $CancellablePromise<$models.NodeImageResult> {
    return $Call.ByID(4062595242, rawURL, imageKey, profile, reload);
}
